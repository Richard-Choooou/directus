...
import { Field, GeometryOptions } from '@directus/types';
...
console.log('collection', props.collection, props.fieldsInCollection)
console.log('props.fieldsInCollection', props.fieldsInCollection)
const { t, n } = useI18n();
