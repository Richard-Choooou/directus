...
// function getLayer(sourceId: any, item: any, geometryOptions: any): any {
// 	const types = {
// 		"Point": [{
// 			id: `${sourceId}_points`,
// 			type: 'circle',
...
// 				'circle-stroke-color': item.pointColor,
// 				'circle-stroke-width': 2,
// 			},
// 		}],
// 		"Polygon": [{
// 			id: `${sourceId}_polygons_outline`,
// 			type: 'line',
// 			source: sourceId,
// 			filter: ['all', ['!has', 'point_count'], ['==', '$type', 'Polygon']],
// 			paint: {
// 				'line-color': item.polygonLineColor,
// 				'line-width': 2,
// 			},
// 			layout: {
// 				'line-join': 'round',
...
// 			filter: ['all', ['!has', 'point_count'], ['==', '$type', 'Polygon']],
// 			paint: {
// 				'fill-color': item.polygonFillColor,
// 				'fill-opacity': 0.7,
// 			},
// 		},]
// 	}

// 	return types[geometryOptions.geometryType]
// }
...
// 		// console.log('item', item, props.geometryOptions)
// 		let geojson: any = { type: 'FeatureCollection', features: [] };
// 		geojson = toGeoJSON([item], props.geometryOptions);
// 		const sourceId = `${props.geometryOptions.geometryType}_${item.id}`
...
// 		getLayer(sourceId, item, props.geometryOptions).forEach((layer) => {
